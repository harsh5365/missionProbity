...
<tr>
<td colspan="2" valign="top" bgcolor="#FFFFFF" class="padding_7px"><table border ="0" width="100%"  cellpadding="2" cellspacing="0" align="center" >
<tr>
...
include 'lib/dao.php';
$d = new dao();
$q = $d->select1("sectors", 'name,id');
$i = 0;
while ($result=mysqli_fetch_array($q)) 
{
        $i++;
?>
<li><a class="bluelink11px" href ="sector-result.php?sid=<?php echo $result['id']; ?>"><?php echo $result['name']; ?></a>
<?php }?></li>
